...
package com.dami.fileexplorer.adapter;
...
import com.dami.fileexplorer.view.FileListItemEncrypt;
import com.dami.fileexplorer.view.FileViewInteractionHubEncrypt;


public class FileListCursorAdapterEncrypt extends CursorAdapter {
    ...
    public FileListCursorAdapterEncrypt(Context context, Cursor cursor,
    		FileViewInteractionHubEncrypt f, FileIconHelper fileIcon) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        FileListItemEncrypt.setupFileListItemInfo(mContext, view, fileInfo, mFileIcon,
                mFileViewInteractionHub);
        view.findViewById(R.id.category_file_checkbox_area).setOnClickListener(
                new FileListItemEncrypt.FileItemOnClickListener(mContext, mFileViewInteractionHub));
    }
